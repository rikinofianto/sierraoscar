  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="template/module/export/transaksi_checkout.php"><i class="fa fa-circle-o"></i> Transaksi Check In/Out</a></li>
          <li><a href="template/module/export/transaksi_layanan.php"><i class="fa fa-circle-o"></i> Transaksi Layanan</a></li>
          <li><a href="template/module/export/layanan.php"><i class="fa fa-circle-o"></i> Layanan</a></li>
          <li><a href="template/module/export/tipe_kamar.php"><i class="fa fa-circle-o"></i> Kamar</a></li>
          <li><a href="template/module/export/tamu.php"><i class="fa fa-circle-o"></i> Tamu</a></li>
        </ul>
      </li>
